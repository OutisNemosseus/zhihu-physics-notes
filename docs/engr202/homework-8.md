...
[下载本页 Markdown](https://raw.githubusercontent.com/OutisNemosseus/zhihu-physics-notes/main/docs/engr202/homework-8.md){ .md-button download }

**Type:** Homework

## 完成指引

显示电路化简、复数运算、频率响应或功率计算及单位检查。

...
# Homework #10 Transformers

[下载本页 Markdown](https://raw.githubusercontent.com/OutisNemosseus/zhihu-physics-notes/main/docs/engr202/homework-10-transformers.md){ .md-button download }

**Type:** Homework

## 完成指引

使用匝数比、反射阻抗、极性约定和理想变压器功率关系，显示单位转换。
